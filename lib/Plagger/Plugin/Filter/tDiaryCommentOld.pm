package Plagger::Plugin::Filter::tDiaryCommentOld;
use strict;
...
# http://tdiary.cvs.sourceforge.net/tdiary/plugin/makerss.rb?revision=1.37
our $FeedMagic = <<'MAGIC';
...
Plagger::Plugin::Filter::tDiaryCommentOld - Rate tDiary comment

=head1 SYNOPSIS

    - module: Filter::tDiaryCommentOld
